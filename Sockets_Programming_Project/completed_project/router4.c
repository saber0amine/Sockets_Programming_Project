...
int tableRoutage[4][4] ={
	{1,5,8080},{2,3,8082},{3,3,8085},{5,1,8085}
};
...
/*tableRoutage[0][0]=1; tableRoutage[0][1]=5; tableRoutage[0][2]=8080; 
tableRoutage[1][0]=2; tableRoutage[1][1]=3; tableRoutage[1][2]=8081;
tableRoutage[2][0]=3;  tableRoutage[2][1]=3; tableRoutage[2][2]=8084;
tableRoutage[3][0]=5;  tableRoutage[3][1]=1; tableRoutage[3][2]=8084;*/
