...
int tableRoutage[4][4] ={
	{2,8,8083},{3,1,8083},{4,5,8084},{5,3,8085}
};
...
/*tableRoutage[0][0]=2; tableRoutage[0][1]=8; tableRoutage[0][2]=8082; 
tableRoutage[1][0]=3; tableRoutage[1][1]=1; tableRoutage[1][2]=8082;
tableRoutage[2][0]=4;  tableRoutage[2][1]=5; tableRoutage[2][2]=8083;
tableRoutage[3][0]=5;  tableRoutage[3][1]=3; tableRoutage[3][2]=8084;*/
...
int main()
{
	...
	servaddrr.sin_port = htons(tableRoutage[0][2]);
