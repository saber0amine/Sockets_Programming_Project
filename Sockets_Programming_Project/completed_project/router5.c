...
int tableRoutage[4][4] ={
	{1,3,8081},{2,8,8084},{3,2,8083},{4,1,8084}
};
/*tableRoutage[0][0]=1; tableRoutage[0][1]=3; tableRoutage[0][2]=8080; 
tableRoutage[1][0]=2; tableRoutage[1][1]=8; tableRoutage[1][2]=8081;
tableRoutage[2][0]=3;  tableRoutage[2][1]=2; tableRoutage[2][2]=8082;
tableRoutage[3][0]=4;  tableRoutage[3][1]=1; tableRoutage[3][2]=8083;*/
